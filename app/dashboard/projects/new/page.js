...
import { createProject } from "@/lib/firestore-admin";
    ...
    <div className="section-compact">
      <Container>
        <div className="max-w-3xl mx-auto space-y-6">
          <div>
            <h1 className="text-4xl font-semibold text-[#1a1a1a]">New Project</h1>
            <p className="text-[#6d6d6d] mt-2">Create a new project listing</p>
          </div>
